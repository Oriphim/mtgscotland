            ...
            ListViewMenu.ItemsSource = menuItems = new List<HomeMenuItem>
                {
                    ...
                    new HomeMenuItem { Title = "Events", MenuType = MenuType.Twitter, Icon = "twitternav.png" },
                 //   new HomeMenuItem { Title = "Hanselminues", MenuType = MenuType.Hanselminutes, Icon = "hm.png" },
                    new HomeMenuItem { Title = "Local Game Stores", MenuType =MenuType.Ratchet, Icon = "ratchet.png" },
