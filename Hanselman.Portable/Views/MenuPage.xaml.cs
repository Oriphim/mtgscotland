    ...
    public partial class MenuPage : ContentPage
    {
        ...
        public MenuPage(RootPage root)
        {
            ...
            ListViewMenu.ItemsSource = menuItems = new List<HomeMenuItem>
				...
				new HomeMenuItem { Title = "Events", MenuType = MenuType.Events, Icon = "events.png" },
                 //   new HomeMenuItem { Title = "Hanselminues", MenuType = MenuType.Hanselminutes, Icon = "hm.png" },
				new HomeMenuItem { Title = "Local Game Stores", MenuType =MenuType.Stores, Icon = "stores.png" },
