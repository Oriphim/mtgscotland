...
{
	public class StoresPageViewModel : BaseViewModel
	{
		...
		private async Task ExecuteLoadItemsCommand()
		{
			...
			try
			{
				...
				{
					var feed = "https://dl.dropboxusercontent.com/u/11844221/MTGSCOT/stores.xml";
			...
			if (error)
			{
				...
				await page.DisplayAlert("Error", "Unable to load stores.", "OK");
